...
for star in tqdm(stars, position=0, leave=True):
    ...
    stellar_parameters = literature_parameters_df[literature_parameters_df['Name'] == star]
    ...
    for element in elements:
        ...
        abundances_results = pd.read_csv(abundances_save_dir+star+'_'+element+'_abundances_v3.csv')
